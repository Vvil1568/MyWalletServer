...
public class DatabaseAPI {
    ...
    /**
     * Adds data about user
     */
    public static void addUserData(String username, String category, String type, int amount, String date, int currency) {
        try {
            ...
            System.out.println("Error in adding user data" + e.getMessage());
        }
    }
}
